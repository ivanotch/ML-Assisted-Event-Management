...
export default function CalendarPage() {
    const [currentDate, setCurrentDate] = useState(new Date(2026, 3, 15)); // Setting context to match mock data
    ...
    const selectedDateEvents = mockEvents.filter(e => isSameDay(new Date(e.date), selectedDate));
                        ...
                        {selectedDateEvents.length > 0 ? (
                            <div className="space-y-4">
                                {selectedDateEvents.map(event => (
                                    ...
                                    >
                                        <div className="text-xs font-medium text-indigo-600 mb-1">{event.time}</div>
            ...
            {selectedEvent && (
                <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                    <div className="bg-white p-6 rounded-xl w-full max-w-lg">
                        ...
                        <img src={selectedEvent.image} className="w-full h-40 object-cover rounded mb-4" />
